...
Attributes.prototype.setDefaults = function(collection, defaults) {
    ...
    if(hop(defaults, 'multitenant')) defaultSettings.multitenant = defaults.multitenant;
    ...
    if(hop(collection, 'multitenant')) defaultSettings.multitenant = collection.multitenant;
    ...
    var flags = {
        ...
        multitenant: defaultSettings.multitenant,
    ...
    if(flags.multitenant === true) {
        flags.multitenant = 'tenantId';
    }
...
Attributes.prototype.autoAttributes = function(collection, connections) {
    ...
    if(collection.multitenant && !attributes[collection.multitenant]) {
        attributes[collection.multitenant] = {type:'text'};
    }
};
